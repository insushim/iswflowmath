...
function StatCardSkeleton() {
  return (
    <div className="relative overflow-hidden rounded-3xl bg-slate-800/40 backdrop-blur-xl border border-white/10 p-6">
...
function BentoCard({
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.6, delay, ease: [0.22, 1, 0.36, 1] }}
      className={`relative overflow-hidden rounded-3xl bg-slate-800/60 backdrop-blur-xl border border-white/10 shadow-xl shadow-black/20 ${className}`}
    >
        ...
        >
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-white via-slate-100 to-slate-200 bg-clip-text text-transparent">
                학습 통계
              </h1>
            </div>
                  ...
                  {recentSessions.map((session, index) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="flex items-center gap-4 p-4 bg-slate-800/60 rounded-2xl border border-white/10 hover:border-white/20 hover:shadow-lg transition-all duration-300 cursor-pointer group"
                      >
